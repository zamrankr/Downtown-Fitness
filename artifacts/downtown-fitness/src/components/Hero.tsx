...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative h-[100dvh] w-full overflow-hidden bg-background flex items-center">
      ...
      >
        <img 
          src="https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&w=640&auto=format&fit=crop" 
          srcSet="https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&w=400&auto=format&fit=crop 400w, https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&w=640&auto=format&fit=crop 640w, https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&w=1080&auto=format&fit=crop 1080w"
          sizes="100vw"
          alt="Gym interior" 
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        ...
        >
          ...
          <motion.h1 
            ...
            className="text-6xl md:text-8xl lg:text-[120px] leading-[0.85] font-bebas tracking-normal uppercase"
          >
          ...
          <motion.p 
            ...
            className="mt-6 text-base md:text-lg text-muted-foreground max-w-xl font-light"
          >
          ...
          >
            <button 
              ...
              className="px-8 py-3 bg-gradient-primary text-white font-bebas text-xl tracking-wider rounded hover-glow transition-all"
            >
              JOIN NOW
            </button>
            <button 
              onClick={() => document.getElementById('contact')?.scrollIntoView({ behavior: 'smooth' })}
              className="px-8 py-3 glass text-white font-bebas text-xl tracking-wider rounded hover:bg-white/10 transition-all border border-white/20"
            >
              CONTACT US
            </button>
          </motion.div>
